...
class DataArguments:
    ...
    offline_traj_only: Optional[bool] = field(default=False)
    offline_reward_path: Optional[str] = field(default=None)
    offline_reward_reduce: Optional[str] = field(default="mean")
